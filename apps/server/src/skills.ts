...
description: Inspect and manage this llm-chat instance, including Agents, Character Cards, conversations, connections, models, MCP servers, Skills, Plugins, and tool settings.
requiredTools: app_agents, app_conversations, app_settings, app_connections, app_models, app_mcp_servers, app_skills, app_plugins, app_tool_settings
---
# llm-chat Operator
